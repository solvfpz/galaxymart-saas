  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center p-4 bg-brand-bg">
        ...
        <button onClick={() => navigate('/')} className="px-6 py-2 bg-brand-primary rounded-full text-white">Go Back</button>
      </div>
    );
  }
              ...
              <div className="p-6 sm:p-8">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-6">
                  <div>
                    ...
                    <p className="mt-2 text-sm text-zinc-400 leading-relaxed">
                      {product.perks.join(" • ")}. High-quality service with instant delivery guaranteed.
                    </p>
                  </div>
                  <div className="flex items-baseline gap-2">
                    <div className="text-2xl font-bold tracking-tight text-white">{product.price}</div>
                ...
                <div className="mt-6 flex flex-wrap items-center gap-3">
                  <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-xl">
                    ...
                    <span className="text-[10px] font-bold text-zinc-300 uppercase tracking-widest">{product.stock} In stock</span>
                  </div>
                  <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 backdrop-blur-xl">
